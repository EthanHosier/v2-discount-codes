...
const TermsAndConditionsPage = () => {
 ...
 <h3>Last updated December 12, 2022</h3>
 ...
 <h3>TABLE OF CONTENTS</h3>
  ...
  <ol>
 <li><a href="#ct-1">AGREEMENT TO TERMS</a></li>
 <li><a href="#ct-2">INTELLECTUAL PROPERTY RIGHTS</a></li>
 <li><a href="#ct-3">USER REPRESENTATIONS</a></li>
 <li><a href="#ct-4">PROHIBITED ACTIVITIES</a></li>
 <li><a href="#ct-5">USER GENERATED CONTRIBUTIONS</a></li>
 <li><a href="#ct-6">CONTRIBUTION LICENSE</a></li>
 <li><a href="#ct-7">GUIDELINES FOR REVIEWS</a></li>
 <li><a href="#ct-8">SUBMISSIONS</a></li>
 <li><a href="#ct-9">THIRD-PARTY WEBSITE AND CONTENT</a></li>
 <li><a href="#ct-10">ADVERTISERS</a></li>
 <li><a href="#ct-11">SITE MANAGEMENT</a></li>
 <li><a href="#ct-12">PRIVACY POLICY</a></li>
 <li><a href="#ct-13">TERM AND TERMINATION</a></li>
 <li><a href="#ct-14">MODIFICATIONS AND INTERRUPTIONS</a></li>
 <li><a href="#ct-15">GOVERNING LAW</a></li>
 <li><a href="#ct-16">DISPUTE RESOLUTION</a></li>
 <li><a href="#ct-17">CORRECTIONS</a></li>
 <li><a href="#ct-18">DISCLAIMER</a></li>
 <li><a href="#ct-19">LIMITATIONS OF LIABILITY</a></li>
 <li><a href="#ct-20">INDEMNIFICATION</a></li>
 <li><a href="#ct-21">USER DATA</a></li>
 <li><a href="#ct-22">ELECTRONIC COMMUNICATIONS, TRANSACTIONS, AND SIGNATURES</a></li>
 <li><a href="#ct-23">CALIFORNIA USERS AND RESIDENTS</a></li>
 <li><a href="#ct-24">MISCELLANEOUS</a></li>
 <li><a href="#ct-25">CONTACT US</a></li>
 </ol>
  
 <h3 id="ct-1">1. AGREEMENT TO TERMS</h3>
  
 <p>These Terms of Use constitute a legally binding agreement made between you, whether personally or on behalf of an entity (“you”) and Voucher Frog ("Company," “we," “us," or “our”), concerning your access to and use of the voucherfrog.com website as well as any other media form, media channel, mobile website or mobile application related, linked, or otherwise connected thereto (collectively, the “Site”). We are registered in England and have our registered office at 38 Christchurch Road, London, Sidcup DA157HQ. You agree that by accessing the Site, you have read, understood, and agreed to be bound by all of these Terms of Use. IF YOU DO NOT AGREE WITH ALL OF THESE TERMS OF USE, THEN YOU ARE EXPRESSLY PROHIBITED FROM USING THE SITE AND YOU MUST DISCONTINUE USE IMMEDIATELY.</p>
 ...
 <h3 id="ct-2">2. INTELLECTUAL PROPERTY RIGHTS</h3>
 ...
 <h3 id="ct-3">3. USER REPRESENTATIONS</h3>
 ...
 <h3 id="ct-4">4. PROHIBITED ACTIVITIES</h3>
 ...
 <h3 id="ct-5">5. USER GENERATED CONTRIBUTIONS</h3>
 ...
 <h3 id="ct-6">6. CONTRIBUTION LICENSE</h3>
 ...
 <h3 id="ct-7">7. GUIDELINES FOR REVIEWS</h3>
 ...
 <h3 id="ct-9">9. THIRD-PARTY WEBSITE AND CONTENT</h3>
 ...
 <h3 id="ct-11">11. SITE MANAGEMENT</h3>
 ...
 <h3 id="ct-14">14. MODIFICATIONS AND INTERRUPTIONS</h3>
 ...
 <h3 id="ct-15">15. GOVERNING LAW</h3>
  
 <p>These conditions are governed by and interpreted following the laws of England, and the use of the United Nations Convention of Contracts for the International Sale of Goods is expressly excluded. If your habitual residence is in the EU, and you are a consumer, you additionally possess the protection provided to you by obligatory provisions of the law of your country of residence. Voucher Frog and yourself both agree to submit to the non-exclusive jurisdiction of the courts of Sidcup, which means that you may make a claim to defend your consumer protection rights in regards to these Terms of Use in England, or in the EU country in which you reside.</p>
  
  
 <h3 id="ct-16">16. DISPUTE RESOLUTION</h3>
 ...
 <h3 id="ct-19">19. LIMITATIONS OF LIABILITY</h3>
  
 <p>IN NO EVENT WILL WE OR OUR DIRECTORS, EMPLOYEES, OR AGENTS BE LIABLE TO YOU OR ANY THIRD PARTY FOR ANY DIRECT, INDIRECT, CONSEQUENTIAL, EXEMPLARY, INCIDENTAL, SPECIAL, OR PUNITIVE DAMAGES, INCLUDING LOST PROFIT, LOST REVENUE, LOSS OF DATA, OR OTHER DAMAGES ARISING FROM YOUR USE OF THE SITE, EVEN IF WE HAVE BEEN ADVISED OF THE POSSIBILITY OF SUCH DAMAGES.</p>
  
  
 <h3 id="ct-20">20. INDEMNIFICATION</h3>
 ...
 <h3 id="ct-23">23. CALIFORNIA USERS AND RESIDENTS</h3>
  
 <p>If any complaint with us is not satisfactorily resolved, you can contact the Complaint Assistance Unit of the Division of Consumer Services of the California Department of Consumer Affairs in writing at 1625 North Market Blvd., Suite N 112, Sacramento, California 95834 or by telephone at (800) 952-5210 or (916) 445-1254.</p>
  
  
 <h3 id="ct-24">24. MISCELLANEOUS</h3>
 ...
 <h3 id="ct-25">25. CONTACT US</h3>
  
 <p>In order to resolve a complaint regarding the Site or to receive further information regarding use of the Site, please contact us at:</p>
  
 <p>
   Voucher Frog<br/>
   Phone: 07476133726<br/>
   thevoucherfrog@gmail.com
 </p>
